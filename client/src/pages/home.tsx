    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
        ...
        <div className="container relative z-10 px-6 pt-20">
          ...
          >
            <h1 className="text-5xl md:text-8xl font-display font-bold leading-tight mb-6 tracking-tight text-transparent bg-clip-text bg-gradient-to-b from-white to-white/50">
              Future Proof<br />
              <span className="text-primary text-glow">Digital Experiences</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="/services">
                <Button variant="outline" size="lg" className="rounded-full px-8 h-12 text-lg border-white/20 hover:bg-white/10">
                  Explore Services
                </Button>
              </Link>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="group p-8 rounded-2xl bg-white/5 border border-white/10 hover:border-primary/50 transition-all duration-300 hover:-translate-y-2"
              >
      ...
      <section className="py-32 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          <h2 className="text-5xl md:text-7xl font-display font-bold mb-8">Ready to transform?</h2>
          ...
          <Link href="/contact">
            <Button size="lg" className="bg-white text-black hover:bg-white/90 rounded-full px-10 h-14 text-lg font-bold">
              Let's Talk
            </Button>
          </Link>
        </div>
